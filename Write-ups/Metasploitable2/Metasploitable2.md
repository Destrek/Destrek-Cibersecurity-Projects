...
Intenté ir ahora hacia bases de datos. Cogí, para ello, los puertos asociados a MySQL y PostgreSQL y les hice un barrido con nmap. Pero de primeras no salía nada. 
...
Nada.
Pero desde la conexión SSH a la máquina víctima, intentando listar los directorios web vi cómo funcionaban: 
...
Los probé todos en DVWA y funcionaron. Los propios usuarios de MySQL no tenían ninguna contraseña asignada. Sólo había tres usuarios. 
